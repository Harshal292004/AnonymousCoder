...
def create_graph(llm: BaseChatModel)->CompiledStateGraph:
    ...
    summarization_node=get_summarization_node(llm=llm)
    ...
    builder.add_edge("memory_node","summarization_node")
    builder.add_edge("summarization_node","understanding_node")
